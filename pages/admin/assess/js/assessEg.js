  ...
  var assess = {
    ...
    groupChange: function () {
      ...
      if (sum >= 1) {
        ...
        this.$yearSelected.empty();
        this.$yearSelected.html('<option value="hasnot">temporarily no data</option>');
      }
      ...
      if (items.length > 0) {
        ...
        this.$groupItemSelected.empty();
        this.$groupItemSelected.html('<option value="hasnot">temporarily no data</option>');
      }
    },
    yearChange: function () {
      var select = this.$typeSelected;
            ...
            $(res.GameGroups).each(function (index, item) {
              if (item.groupName === groupSelected) {
                ...
                for (var i = 1; i <= period; i++) {
                  periodOpt += '<option value="' + i + '">number' + i + 'cycle</option>';
                }
    ...
    renderChart: function () {
      ...
      if (item !== 7 && item !== 5) {
        ...
        this.option.title.subtext = 'grouping：' + _this.groupmap[group].name;
    ...
    renderChartOfEquity: function (data) {
      ...
      this.option.subtext = 'grouping：' + _this.groupmap[group].name + ' number' + year + 'year';

      var xAxis =  new Array();
      var series =  new Array();

      $(data).each(function (index, item) {
        xAxis.push('number' + (index + 1) + 'period');
