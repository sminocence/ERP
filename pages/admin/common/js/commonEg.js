(function() {
	var common = {
		...
		exitSystem : function() {
			var _this = this;
			DIALOG.confirm('OK to exit？', function() {
				//注销管理员的session
				$.post('adminOperateAction!adminLogout.action', {
					username : _this.username
				}, function(res) {
					//window.location.href = res.url;
					window.location.replace('../../../indexeg.html');
				});
			...
			this.dialog = new DIALOG(
					{
						...
						content : '<div class="dialog-body" id="modifyPass-wrapper">'
								...
								+ '<label class="label-div"><span class="start">*</span>old password</label>'
								+ '<div class="label-input">'
								+ '<input type="password" class="form-control" name = "oldPWD" data-validation="required"'
								+ ' data-validation-error-msg="Please enter the original password" name="type"/>'
								+ '</div>'
								+ '</div>'
								+ '<div class="input-div clear-fix">'
								+ '<label class="label-div"><span class="start">*</span>new password</label>'
								+ '<div class="label-input">'
								+ '<input type="password" name="psd" class="form-control"/>'
								+ '</div>'
								+ '</div>'
								+ '<div class="input-div clear-fix">'
								+ '<label class="label-div"><span class="start">*</span>Confirm the new password</label>'
								+ '<div class="label-input">'
								+ '<input type="password" data-validation-confirm="psd" class="form-control"'
   								+ 'data-validation-error-msg="Two passwords are inconsistent" data-validation="confirmation"/>'
								+ '</div>'
								+ '</div>'
								+ '</form>'
